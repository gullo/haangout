  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-x-0 top-24 z-10 px-5 sm:px-10">
        <div className="mx-auto flex max-w-[1400px] items-center justify-between rounded-full bg-[var(--color-page)]/80 px-4 py-2 backdrop-blur-md text-[11px] uppercase tracking-[0.2em] text-foreground/90">
